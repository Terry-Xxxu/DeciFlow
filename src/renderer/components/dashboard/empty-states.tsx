      ...
      <div className="relative flex flex-col items-center justify-center px-8 py-20">
        ...
        <div className="relative mb-8">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, oklch(0.6 0.2 255), oklch(0.6 0.18 280))",
              boxShadow: "0 0 30px oklch(0.6 0.2 255 / 0.3)",
            }}
          >
            {/* Explicitly set fill=white and stroke=none so it stays white in dark mode */}
            {/* fill="white" wins over Tailwind's svg{} rule via attribute > class */}
            <svg
