...
const sourceTypes = [
  { id: "postgresql", name: "PostgreSQL", icon: "🐘", color: "bg-blue-500/10 text-blue-500" },
  { id: "mysql", name: "MySQL", icon: "🐬", color: "bg-orange-500/10 text-orange-500" },
  { id: "mongodb", name: "MongoDB", icon: "🍃", color: "bg-green-500/10 text-green-500" },
  { id: "sqlite", name: "SQLite", icon: "📁", color: "bg-purple-500/10 text-purple-500" },
]
